...
start_server () {
  ...
  cliww --limit $cliww_limit --keepalive --password $cliww_password java -Dterminal.ansi=true -Xms${Xms} -Xmx${Xmx} -jar forge-$forge_version.jar -nogui -Dlog4j.configurationFile=log4j2_112-116.xml
}
